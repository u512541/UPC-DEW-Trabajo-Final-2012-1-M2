...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { Direccion: @factura.Direccion, Dueno: @factura.Dueno, FechaRegistro: @factura.FechaRegistro, MontoTotal: @factura.MontoTotal, Paciente: @factura.Paciente, Ruc: @factura.Ruc }
    end
  ...
  test "should update factura" do
    put :update, id: @factura, factura: { Direccion: @factura.Direccion, Dueno: @factura.Dueno, FechaRegistro: @factura.FechaRegistro, MontoTotal: @factura.MontoTotal, Paciente: @factura.Paciente, Ruc: @factura.Ruc }
    assert_redirected_to factura_path(assigns(:factura))
  end
